    ...
    <div class="col md-8">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{url('admin/pelayanan/edit/'.$q->id)}}" class="btn btn-outline-warning btn-sm"><i class="fas fa-pen"></i></a>
        ...
        <hr>
          <a href="{{url('admin/pelayanan/add')}}" class="btn btn-outline-primary btn-lg"><i class="fas fa-plus-square"></i></a>
      </div>
    </div>
  </div>
@endsection